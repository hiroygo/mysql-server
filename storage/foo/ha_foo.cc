...
/**
  ...
  ha_foo::extra() are hints as to what will be occurring to the request.

  A Longer Foo can be found called the "Skeleton Engine" which can be
...
Foo_share::Foo_share() { thr_lock_init(&lock); }
...
/**
  @brief
  Foo of simple lock controls. The "share" it creates is a
  structure we will pass to each foo handler. Do you have to have
  one of these? Well, you have pieces that are used for locking, and
  they are needed to function.
*/

Foo_share *ha_foo::get_share() {
  Foo_share *tmp_share;

  DBUG_TRACE;

  lock_shared_ha_data();
  if (!(tmp_share = static_cast<Foo_share *>(get_ha_share_ptr()))) {
    tmp_share = new Foo_share;
...
*/
int ha_foo::update_row(const uchar *, uchar *) {
  DBUG_TRACE;
...
int ha_foo::delete_row(const uchar *) {
  DBUG_TRACE;
  return HA_ERR_WRONG_COMMAND;
}
...
int ha_foo::index_read_map(uchar *, const uchar *, key_part_map,
...
*/
void ha_foo::position(const uchar *) { DBUG_TRACE; }
...
*/
int ha_foo::rnd_pos(uchar *, uchar *) {
  int rc;
  DBUG_TRACE;
  rc = HA_ERR_WRONG_COMMAND;
  return rc;
...
/**
  ...
  ha_innodb.cc
*/
int ha_foo::extra(enum ha_extra_function) {
  DBUG_TRACE;
  return 0;
}
...
*/
int ha_foo::external_lock(THD *, int) {
  DBUG_TRACE;
  return 0;
}
...
*/
THR_LOCK_DATA **ha_foo::store_lock(THD *, THR_LOCK_DATA **to,
...
*/
int ha_foo::rename_table(const char *, const char *, const dd::Table *,
                             dd::Table *) {
  DBUG_TRACE;
  return HA_ERR_WRONG_COMMAND;
}
...
*/
ha_rows ha_foo::records_in_range(uint, key_range *, key_range *) {
  DBUG_TRACE;
...
static SYS_VAR *foo_system_variables[] = {
...
// this is an foo of SHOW_FUNC
static int show_func_foo(MYSQL_THD, SHOW_VAR *var, char *buf) {
  var->type = SHOW_CHAR;
...
foo_vars_t foo_vars = {100, 20.01, "three hundred", true, false, 8250};

static SHOW_VAR show_status_foo[] = {
...
static SHOW_VAR show_array_foo[] = {
...
static SHOW_VAR func_status[] = {
    {"foo_func_foo", (char *)show_func_foo, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"foo_status_var5", (char *)&foo_vars.var5, SHOW_BOOL,
     SHOW_SCOPE_GLOBAL},
    {"foo_status_var6", (char *)&foo_vars.var6, SHOW_LONG,
     SHOW_SCOPE_GLOBAL},
    {"foo_status", (char *)show_array_foo, SHOW_ARRAY,
     SHOW_SCOPE_GLOBAL},
    {nullptr, nullptr, SHOW_UNDEF, SHOW_SCOPE_UNDEF}};
